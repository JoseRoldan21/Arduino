...
void loop()
{
  ...
  digitalWrite(led0, HIGH);    // posar a 5V el pin 5  Primer
  ...
  digitalWrite(led0, HIGH);     // posar a 0V el pin 5       Segon 
  ...
  delay(velocitat);                  // es queden leds 500ms apagats
   ...
   digitalWrite(led0,LOW);    // posar a 5V el pin 5       Tercer
  ...
  digitalWrite(led0,LOW);    // posar a 5V el pin 5       Quart
  digitalWrite(led1, LOW);    // posar a 5V el pin 6
  digitalWrite(led2, HIGH);    // posar a 5V el pin 7
